...
export const POST = async (req: Request) => {
    ...
    const mailOptions = {
        ...
        text: `Hello ${userName},\n\nThank you for completing the onboarding process, and welcome to OpenSkills! You're on the right path to improving and acquiring new skills to embrace the future, which will require continuous upskilling and reskilling. You've already taken the first step in this journey!\n\nYour User ID is: **${userId}**\n\nTo help you get started, we invite you to chat with our AI coach. Please note that you need to be a ChatGPT+ subscriber to access this feature. [Click here to begin your conversation](https://chatgpt.com/g/g-kqRCHmM5H-openskills) and explore how it can assist you on your learning journey.\n\nIf you have any questions or need assistance, feel free to reach out to our support team at support@openskills.online.\n\nBest regards,\n\nOtavio Serra\nFounder & CEO\n[openskills.online](https://openskills.online)`
    };
