  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">Configure your memory orchestrator system</p>
      </div>
        ...
        <div className="border-b border-slate-200">
          <nav className="flex" aria-label="Settings Tabs">
            <button
              ...
              className={`px-4 py-4 font-medium text-sm ${activeTab === 'general'
            ...
            <button
              ...
              className={`px-4 py-4 font-medium text-sm ${activeTab === 'memory'
                  ? 'border-b-2 border-indigo-600 text-indigo-600'
                  : 'text-slate-500 hover:text-slate-700'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-4 font-medium text-sm ${activeTab === 'context'
                  ? 'border-b-2 border-indigo-600 text-indigo-600'
                  : 'text-slate-500 hover:text-slate-700'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-4 font-medium text-sm ${activeTab === 'api'
                  ? 'border-b-2 border-indigo-600 text-indigo-600'
                  : 'text-slate-500 hover:text-slate-700'
                }`}
            >
